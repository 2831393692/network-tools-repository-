...
class PingTestPage(QWidget):
    ...
    def create_single_tab(self):
        ...
        self.single_count.setStyleSheet(SPINBOX_STYLE)
        ...
        self.single_size.setStyleSheet(SPINBOX_STYLE)
    ...
    def create_continuous_tab(self):
        ...
        self.cont_interval.setStyleSheet(SPINBOX_STYLE)
        ...
        self.cont_size.setStyleSheet(SPINBOX_STYLE)
    ...
    def create_batch_tab(self):
        ...
        self.batch_timeout.setStyleSheet(SPINBOX_STYLE)
        ...
        self.batch_concurrent.setStyleSheet(SPINBOX_STYLE)
        ...
        self.batch_mode.setStyleSheet(SPINBOX_STYLE)
        ...
        self.batch_interval.setStyleSheet(SPINBOX_STYLE)
    ...
    def create_subnet_tab(self):
        ...
        self.subnet_iface.setStyleSheet(SPINBOX_STYLE)
        ...
        self.subnet_range.setStyleSheet(SPINBOX_STYLE)
        ...
        self.subnet_timeout.setStyleSheet(SPINBOX_STYLE)
        ...
        self.subnet_size.setStyleSheet(SPINBOX_STYLE)
        ...
        self.subnet_threads.setStyleSheet(SPINBOX_STYLE)
    ...
    def create_tcp_tab(self):
        ...
        self.tcp_port.setStyleSheet(SPINBOX_STYLE)
        ...
        self.tcp_count.setStyleSheet(SPINBOX_STYLE)
        ...
        self.tcp_timeout.setStyleSheet(SPINBOX_STYLE)
