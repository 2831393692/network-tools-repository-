...
class ConnectionTestPage(QWidget):
    ...
    def _build_telnet_page(self):
        ...
        self.telnet_port_input.setStyleSheet(self._spinbox_style())
        ...
        self.telnet_timeout_input.setStyleSheet(self._spinbox_style())
    ...
    def _build_ssl_page(self):
        ...
        self.ssl_port_input.setStyleSheet(self._spinbox_style())
    ...
    def _build_ssl_enhanced_page(self):
        ...
        self.ssl_enhanced_port_input.setStyleSheet(self._spinbox_style())
    ...
    def _build_password_gen_page(self):
        ...
        self.password_length_input.setStyleSheet(self._spinbox_style())
